...
For each $k$ value, obtaining classification data was repeated 10 times each
with a different scrambled training set. The accuracies shown in the data
section are an average of these 10 trials.
